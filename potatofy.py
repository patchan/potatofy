...
class Holdings:
    ...
    def init_control_bar(self):
        ...
        tk.Button(self.control, text="Refresh Portfolio", command=self.init).grid(row=0, column=0)
    ...
    def setup_cash(self):
        ...
        self.cash.config(text=self.potatofy.get_cash())
